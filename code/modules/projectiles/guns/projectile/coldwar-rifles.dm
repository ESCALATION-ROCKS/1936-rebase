...
/obj/item/weapon/gun/projectile/automatic/rifle/rk62
	...
	dist_shot_sound = 'sound/weapons/gunshot/dist/ak_dist.wav'
	firemodes = list(
		list(mode_name="semiauto",     burst=1, fire_delay=1, move_delay=null, one_hand_penalty=4, burst_accuracy=null,              dispersion=null, automatic = 10),
...
/obj/item/weapon/gun/projectile/automatic/rifle/sterling
	...
	allowed_magazines = list(/obj/item/ammo_magazine/a9x19)
	magazine_type = null
	one_hand_penalty = 5
	accuracy = 2.5
	fire_delay = 2
